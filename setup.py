    ...
    setup(
        ...
        entry_points={
          ...
          'pangadfs.fitness': ['fitness_default = pangadfs.fitness:FitnessDefault',
                               ...
                               'fitness_multioptimizer_field_ownership = pangadfs.fitness_multioptimizer_field_ownership:FitnessMultiOptimizerFieldOwnership'],
          ...
          'pangadfs.optimize': ['optimize_default = pangadfs.optimize:OptimizeDefault',
                                ...
                                'optimize_multioptimizer_field_ownership = pangadfs.optimize_multioptimizer_field_ownership:OptimizeMultiOptimizerFieldOwnership'],
